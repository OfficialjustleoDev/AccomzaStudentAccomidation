...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         <h3>Find your perfect Accomidation</h3>
         <div class="box">
         ...
         <div class="flex">
            <div class="box">
               <p>Accomidation Type <span>*</span></p>
               <select name="h_type" class="input" required>
                  <option value="flat">Flat</option>
                  <option value="house">House</option>
                  <option value="shop">NSFAS Accredited</option>
               </select>
            </div>
            <div class="box">
...
<section class="services">
   ...
   <h1 class="heading">What Accomza Offers</h1>

   <div class="box-container">

      <div class="box">
         <img src="images/icon-1.png" alt="">
         <h3>Buy Accomidation</h3>

      </div>

      <div class="box">
         <img src="images/icon-2.png" alt="">
         <h3>Rent Accomidation</h3>
       
      </div>

      <div class="box">
         <img src="images/icon-3.png" alt="">
         <h3>Sell Accomidation</h3>
      </div>
